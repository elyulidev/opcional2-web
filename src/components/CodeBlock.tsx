...
export function CodeBlock({
	...
	return (
		<div
			className={`relative group border-4 border-zinc-900 dark:border-zinc-100 shadow-[8px_8px_0px_#ec4899] dark:shadow-[8px_8px_0px_#ec4899] my-10 bg-[#1E1E1E] ${className || ""}`}
		>
			<div className='absolute top-0 right-0 py-2 flex items-center justify-between w-full bg-zinc-900 dark:bg-[#111111] px-4 border-b-4 border-zinc-900 dark:border-zinc-100 z-10 text-white'>
				<span className='text-sm font-mono font-bold uppercase tracking-widest text-secondary'>
					{language}
				</span>
				<button
					onClick={copy}
