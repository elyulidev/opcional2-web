		...
		<>
			...
			<Box className='bg-primary/10 border-black dark:border-white mb-16 p-10 shadow-[12px_12px_0px_0px_rgba(255,50,150,1)] dark:shadow-[12px_12px_0px_0px_rgba(255,50,150,0.5)]'>
				...
				<div className='space-y-4 text-lg leading-relaxed text-zinc-800 dark:text-zinc-200'>
					<p>
						Nas conferências anteriores usamos testes sem parar para falar sobre eles. Agora vamos abrir o capô e entender o que está lá dentro.
					</p>
					<p>
						Um teste automatizado, na sua forma mais simples, é isto:
					</p>
					<p className='font-black text-2xl py-6 px-8 border-l-8 border-primary bg-white dark:bg-zinc-900 shadow-brutalist uppercase italic tracking-tighter'>
						"Um pedaço de código que chama outro pedaço de código e verifica se o resultado é o que se esperava."
					</p>
					<p>
						Só isso. Não há magia. Não há mistério. O que torna os testes poderosos não é a sua complexidade técnica — é a disciplina e a consistência com que são escritos.
					</p>
					<p>
						Vamos dissecar um teste como um biólogo disseca um organismo. Vamos ver cada célula, cada órgão, e entender para que serve.
					</p>
				</div>
			</Box>
			...
			<section className='mb-24 relative'>
				...
				<h2 className='text-4xl font-black uppercase mb-8 flex items-center gap-4 group'>
					...
					<span className='border-b-8 border-primary'>A anatomia básica de um teste</span>
				</h2>
				<p className='text-xl mb-10 font-medium text-zinc-700 dark:text-zinc-300'>
					Todo teste bem escrito tem exatamente três partes. Estas partes têm um nome famoso no mundo do testing:
					<br />
					<span className='text-2xl font-black text-primary mt-2 block underline decoration-secondary decoration-wavy'>
						Arrange — Act — Assert
					</span>
				</p>
				<p className='text-lg mb-8 italic'>Em português: Preparar — Agir — Verificar</p>
				
				<Box className='bg-secondary/5 border-secondary p-10 mb-12 shadow-brutalist'>
					<h3 className='text-2xl font-black uppercase mb-6 flex items-center gap-3'>
						<span className='w-12 h-12 flex items-center justify-center bg-secondary text-white rounded-lg'>🩺</span>
						A analogia do médico
					</h3>
					<div className='space-y-6 text-lg'>
						<p>Imagine um médico que quer testar se um novo medicamento baixa a pressão arterial.</p>
						<ul className='space-y-4'>
							<li className='flex gap-4'>
								<span className='font-black text-secondary bg-secondary/10 px-2 h-fit'>Arrange:</span>
								<div>O médico seleciona um paciente. Mede a pressão antes de dar o medicamento. Registra: <strong>pressão inicial = 160 mmHg</strong>. Prepara tudo.</div>
							</li>
							<li className='flex gap-4'>
								<span className='font-black text-secondary bg-secondary/10 px-2 h-fit'>Act:</span>
								<div>O médico administra o medicamento. Espera o tempo necessário.</div>
							</li>
							<li className='flex gap-4'>
								<span className='font-black text-secondary bg-secondary/10 px-2 h-fit'>Assert:</span>
								<div>O médico mede a pressão novamente. Verifica se está abaixo de 140 mmHg como esperado. Se estiver, o teste passou. Se não estiver, o teste falhou.</div>
							</li>
						</ul>
					</div>
				</Box>
				...
				<div className='mt-12'>
					<Callout type="info" title="Por que separar em três partes?">
						<p className='mb-4 font-medium leading-relaxed'>
							Esta separação não é apenas estética. Tem um propósito prático muito importante. Quando um teste falha, você precisa saber onde está o problema. Se o teste está organizado em AAA, você sabe imediatamente:
						</p>
						<ul className='grid grid-cols-1 md:grid-cols-3 gap-4'>
							...
							<li className='p-4 bg-white dark:bg-zinc-800 border-2 border-black dark:border-white'>
								<strong>No Act:</strong> a função está a ser chamada de forma incorreta
							</li>
							<li className='p-4 bg-white dark:bg-zinc-800 border-2 border-black dark:border-white'>
								<strong>No Assert:</strong> a sua expectativa sobre o resultado estava errada
							</li>
						</ul>
						<p className='mt-6 italic font-bold text-center'>
							"Um teste sem esta separação é como um relatório médico sem estrutura — contém informação, mas é difícil de interpretar quando algo corre mal."
						</p>
					</Callout>
				</div>
			</section>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-12 flex items-center gap-4'>
					...
					<span className='border-b-8 border-secondary'>Dissecando cada componente</span>
				</h2>

				<div className='space-y-16'>
					<div>
						<h3 className='text-2xl font-black mb-6 uppercase border-l-8 border-primary pl-4'>O test() — O contentor</h3>
						<p className='text-lg mb-8 leading-relaxed font-medium'>
							O <code>test()</code> é o contentor. Ele define os limites de um teste: onde começa e onde termina. O seu primeiro argumento é o nome do teste, e este nome é crítico.
						</p>
						<Box className='bg-zinc-900 text-white p-8 border-none'>
							<p className='text-xl mb-6 font-black uppercase italic'>Um bom nome de teste responde à pergunta: <span className='text-yellow-400'>"O que acontece quando...?"</span></p>
							<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
								<div className='space-y-3'>
									<p className='text-red-500 font-bold uppercase text-xs tracking-widest'>❌ Nomes ruins — não dizem nada útil:</p>
									<div className='p-3 bg-red-900/30 border-2 border-red-500 text-sm font-mono'>test("teste 1", () => {'{...}'});</div>
									<div className='p-3 bg-red-900/30 border-2 border-red-500 text-sm font-mono'>test("função de desconto", () => {'{...}'});</div>
								</div>
								<div className='space-y-3'>
									<p className='text-green-500 font-bold uppercase text-xs tracking-widest'>✅ Nomes bons — dizem exatamente o que está sendo verificado:</p>
									<div className='p-3 bg-green-900/30 border-2 border-green-500 text-sm font-mono'>test("aplica 10% de desconto em produtos com preço maior que 100", () => {'{...}'});</div>
									<div className='p-3 bg-green-900/30 border-2 border-green-500 text-sm font-mono'>test("lança erro quando o preço é negativo", () => {'{...}'});</div>
								</div>
							</div>
						</Box>
						<p className='mt-8 text-lg font-medium text-zinc-600 dark:text-zinc-400 italic'>
							"Por quê isso importa? Porque quando o teste falha, o nome é a primeira coisa que você vê no terminal."
						</p>
					</div>

					<div>
						<h3 className='text-2xl font-black mb-6 uppercase border-l-8 border-secondary pl-4'>O expect() — A afirmação</h3>
						<p className='text-lg mb-8 leading-relaxed font-medium'>
							O <code>expect()</code> é onde fazemos a afirmação. Ele recebe o valor real — o que a função realmente retornou — e o compara com o que esperávamos.
						</p>
						<Box className='bg-primary/5 border-primary p-8'>
							<p className='text-lg mb-6'>
								Pense no <strong>expect</strong> como um juiz. Você apresenta duas evidências: o que aconteceu e o que deveria ter acontecido.
							</p>
							<div className='flex flex-col md:flex-row items-center justify-center gap-6 text-2xl font-black uppercase'>
								<span className='px-4 py-2 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-black'>expect</span>
								<span className='text-zinc-400'>( O QUE ACONTECEU )</span>
								<span className='text-primary decoration-double underline'>.matcher</span>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-12 flex items-center gap-4'>
					...
					<span className='border-b-8 border-primary'>Os matchers essenciais</span>
				</h2>

				<div className='space-y-16'>
					<div>
						<h3 className='text-2xl font-black mb-6 flex items-center gap-3'>
							<span className='w-12 h-12 flex items-center justify-center bg-blue-500 text-white rounded-full'>1</span>
							toBe() — Igualdade exata
						</h3>
						<p className='text-lg mb-6 leading-relaxed font-medium'>
							Verifica se dois valores são exatamente iguais. Usa o operador <code>===</code> internamente.
						</p>
						<CodeBlock
							language="typescript"
						...
						<Callout type="warning" title="ARMADILHA FATAL" className='mt-8'>
							<p className='font-bold text-xl mb-4'>toBe() não deve ser usado com objetos e arrays.</p>
							<CodeBlock
								language="typescript"
							...
							<p className='mt-4 font-medium text-lg leading-relaxed'>
								Por quê? Porque <code>toBe</code> verifica se são o MESMO objeto na memória. Para o conteúdo, use <code>toEqual()</code>.
							</p>
						</Callout>
					</div>
					...
					<div>
						<h3 className='text-2xl font-black mb-6 flex items-center gap-3'>
							<span className='w-12 h-12 flex items-center justify-center bg-green-500 text-white rounded-full'>2</span>
							toEqual() — Igualdade de conteúdo
						</h3>
						<p className='text-lg mb-6 leading-relaxed font-medium'>
							Verifica se dois valores têm o mesmo conteúdo, mesmo que sejam objetos diferentes na memória. Compara recursivamente cada propriedade.
						</p>
						<CodeBlock
							language="typescript"
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
						<Box className='bg-zinc-100 dark:bg-zinc-800 border-black dark:border-white h-full'>
							<h3 className='text-2xl font-black mb-4 uppercase'>Truthy & Falsy</h3>
							<p className='mb-6 font-medium leading-relaxed'>Valores falsy: <code>false, 0, "", null, undefined, NaN</code>. Tudo o resto é truthy.</p>
							<CodeBlock
								language="typescript"
						...
						<Box className='bg-primary/5 border-primary h-full'>
							<h3 className='text-2xl font-black mb-4 uppercase'>Null & Undefined</h3>
							<div className='space-y-4 font-medium'>
								<p><code>null</code> → ausência intencional.</p>
								<p><code>undefined</code> → propriedade não definida.</p>
								<CodeBlock
									language="typescript"
					...
					<Box className='bg-black text-white dark:bg-white dark:text-black py-12 text-center'>
						<h3 className='text-4xl font-black uppercase mb-4 italic tracking-widest'>O modificador .not</h3>
						<p className='text-xl font-medium tracking-tight uppercase'>
							Qualquer matcher pode ser negado com <strong>.not</strong>. É como colocar "não" antes da afirmação.
						</p>
						<div className='mt-8 text-2xl font-mono'>
							expect(resultado)<span className='text-primary'>.not</span>.toBe(0);
						</div>
					</Box>
				</div>
			</section>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-8 flex items-center gap-4'>
					...
					<span className='border-b-8 border-secondary'>Um teste deve verificar uma única coisa</span>
				</h2>
				<p className='text-xl mb-12 font-medium leading-relaxed italic border-l-8 border-secondary pl-6'>
					Esta é uma das regras mais importantes do testing e uma das mais violadas por iniciantes.
				</p>
				<div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
					<div className='space-y-4'>
						<p className='font-black text-red-500 uppercase flex items-center gap-2'>
							<span className='w-6 h-6 flex items-center justify-center bg-red-500 text-white rounded-full'>X</span>
						...
						/>
						<p className='text-sm italic opacity-70'>Se falha, você não sabe o que quebrou sem investigar linha a linha.</p>
					</div>
					<div className='space-y-4'>
						<p className='font-black text-green-500 uppercase flex items-center gap-2'>
							<span className='w-6 h-6 flex items-center justify-center bg-green-500 text-white rounded-full'>✓</span>
						...
						/>
						<p className='text-sm italic opacity-70'>Agora o terminal diz exatamente qual aspeto falhou.</p>
					</div>
				</div>
			</section>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-12 flex items-center gap-4'>
					...
					<span className='border-b-8 border-primary'>Lendo mensagens de erro</span>
				</h2>
				<p className='text-lg mb-8 font-medium'>
					Saber ler as mensagens de erro do Bun é uma habilidade fundamental. Vamos analisar uma falha proposital:
				</p>
				...
				<Box className='relative p-0 overflow-hidden border-4 border-black dark:border-white shadow-[12px_12px_0px_0px_rgba(239,68,68,1)]'>
					<div className='bg-zinc-800 p-3 flex items-center justify-between border-b-2 border-black'>
						<span className='text-xs font-mono text-zinc-400 uppercase tracking-widest'>bun test failure report</span>
					...
					<div className='p-8 bg-zinc-950 font-mono text-sm leading-relaxed text-zinc-300'>
						...
						<p className='mb-4 text-red-400 font-bold'>✗ calcula a média de três notas</p>
						<p className='mb-6 pl-4 border-l-2 border-zinc-800'>
						  expect(received).toBeCloseTo(expected, precision)<br />
						  <br />
						  Expected: <span className='text-white'>13.33</span> (with precision 1)<br />
						  Received: <span className='text-red-400'>40</span>        <span className='text-zinc-600 italic'>← valor real retornado</span>
						</p>
						<div className='text-zinc-500 space-y-1'>
						  <p>12 |   const mediaCalculada = calcularMedia(notas);</p>
						  <p>13 |</p>
						  <p className='text-white'><span className='text-primary'>❯</span> 14 |   expect(mediaCalculada).toBeCloseTo(mediaEsperada, 1);</p>
				...
				<div className='mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 text-center'>
					{[
						...
						<div key={label} className='p-4 border-2 border-black dark:border-white bg-zinc-50 dark:bg-zinc-900'>
							<div className='text-2xl font-black mb-2 text-primary'>{icon}</div>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-12 flex items-center gap-4'>
					...
					<span className='border-b-8 border-secondary'>Exemplo Real: Gestão de Notas</span>
				</h2>
				<p className='text-lg mb-12 font-medium'>
					Imagine que estamos desenvolvendo um sistema de gestão de notas para o ISPM. Juntamos tudo agora num exemplo completo.
				</p>
				<div className='grid grid-cols-1 xl:grid-cols-2 gap-10'>
					<div className='space-y-6'>
						<h3 className='text-xl font-black uppercase text-secondary underline'>Ficheiro de Lógica</h3>
						<CodeBlock
							language="typescript"
					...
					<div className='space-y-6'>
						<h3 className='text-xl font-black uppercase text-primary underline'>Ficheiro de Teste</h3>
						<CodeBlock
							language="typescript"
			...
			<Box className='border-8 border-black dark:border-white p-16 bg-primary/5 mb-32 group hover:bg-primary/10 transition-colors'>
				...
				<div className='space-y-8 text-xl font-medium leading-relaxed text-zinc-800 dark:text-zinc-200'>
					<p>Crie o arquivo <code>src/modulo-01/string-utils.ts</code> com estas funções:</p>
					<ul className='space-y-4'>
						<li className='flex flex-wrap gap-2 items-center'>
							<code className='bg-primary/20 px-2'>capitalizar(texto: string)</code>
							<span className='text-sm opacity-70 italic'>— "ana ferreira" → "Ana Ferreira"</span>
						</li>
						<li className='flex flex-wrap gap-2 items-center'>
							<code className='bg-primary/20 px-2'>contarPalavras(texto: string)</code>
							<span className='text-sm opacity-70 italic'>— "bom dia mundo" → 3</span>
						</li>
						<li className='flex flex-wrap gap-2 items-center'>
							<code className='bg-primary/20 px-2'>inverter(texto: string)</code>
					...
					<p className='font-black text-2xl border-l-8 border-primary pl-6 py-4 bg-white dark:bg-black uppercase italic'>
						Implemente as funções e crie o seu respetivo ficheiro .test.ts usando o que aprendemos hoje.
					</p>
					<div className='p-6 bg-black text-white dark:bg-white dark:text-black font-black uppercase text-center mt-12 hover:scale-105 transition-transform cursor-default'>
						Use toEqual(), toBe(), toBeFalsy() e toBeTruthy() onde fizer sentido!
					</div>
				</div>
			</Box>
