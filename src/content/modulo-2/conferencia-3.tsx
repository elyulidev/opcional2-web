	...
	contenido: (
		<>
			...
			<Box className='bg-primary/10 border-black dark:border-white mb-16 p-10 shadow-[12px_12px_0px_0px_rgba(255,50,150,1)] dark:shadow-[12px_12px_0px_0px_rgba(255,50,150,0.5)] relative overflow-hidden'>
				<div className='absolute -right-10 -top-10 text-9xl text-primary/10 font-black'>
					?
				</div>
				...
				<div className='space-y-4 text-lg leading-relaxed text-zinc-800 dark:text-zinc-200'>
					<p>
						Depois de aprender a escrever testes, a próxima pergunta natural é:
						"O que exatamente devo testar? Testo cada função individualmente?
						Testo o sistema inteiro? Testo tudo ao mesmo tempo?"
					</p>
					<p>
					...
					<p className='font-black text-2xl py-6 px-8 border-l-8 border-primary bg-white dark:bg-zinc-900 shadow-brutalist uppercase italic tracking-tighter'>
						"Ao longo dos anos, a indústria de software desenvolveu uma forma de
						pensar sobre isso que ficou conhecida como a Pirâmide de Testes."
					</p>
				</div>
			</Box>
				...
				<div className='grid grid-cols-1 xl:grid-cols-2 gap-12 items-center'>
					<Box className='bg-zinc-950 text-white p-10 border-none relative overflow-hidden'>
						<div className='flex flex-col items-center space-y-2 relative z-10 font-black uppercase italic tracking-tight'>
							<div
								className='w-24 h-12 bg-rose-500 flex items-center justify-center border-4 border-white transform hover:scale-110 transition-transform cursor-help shadow-lg'
								title='Poucos, lentos e caros'
							>
								E2E
							</div>
							<div
								className='w-48 h-12 bg-amber-500 flex items-center justify-center border-4 border-white transform hover:scale-110 transition-transform cursor-help shadow-lg'
								title='Médios e moderados'
							>
								Integração
							</div>
							<div
								className='w-72 h-12 bg-emerald-500 flex items-center justify-center border-4 border-white transform hover:scale-110 transition-transform cursor-help shadow-lg'
								title='Muitos, rápidos e baratos'
							>
								Unitários
							</div>
						</div>
					...
					<div className='space-y-6'>
						...
						<ul className='space-y-4 text-lg'>
							<li className='flex gap-4'>
								<span className='w-8 h-8 rounded-full bg-black text-white dark:bg-white dark:text-black flex items-center justify-center shrink-0 font-bold italic'>
									1
								</span>
								<p>
									<strong>A base deve ser a maior:</strong> Muitos unitários,
									alguns de integração, poucos end-to-end.
								</p>
							</li>
							<li className='flex gap-4'>
								<span className='w-8 h-8 rounded-full bg-black text-white dark:bg-white dark:text-black flex items-center justify-center shrink-0 font-bold italic'>
								...
								<p>
									<strong>Velocidade vs Custo:</strong> Quanto mais alto, mais
									lento e caro é o teste.
								</p>
							</li>
							<li className='flex gap-4'>
								<span className='w-8 h-8 rounded-full bg-black text-white dark:bg-white dark:text-black flex items-center justify-center shrink-0 font-bold italic'>
								...
								<p>
									<strong>Complementaridade:</strong> Cada camada verifica
									coisas diferentes. Não são substitutos.
								</p>
							</li>
						</ul>
					</div>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-12 flex items-center gap-4'>
					...
					<span className='border-b-8 border-secondary'>Testes Unitários</span>
				</h2>
				...
				<div className='space-y-12'>
					<Box className='bg-emerald-50/50 dark:bg-emerald-950/10 border-emerald-500 p-8'>
						...
						<p className='text-lg leading-relaxed'>
							Um teste unitário verifica uma <strong>única unidade</strong> de
							código num isolamento total. Uma "unidade" é normalmente uma
							função, um método, ou uma classe pequena. Não se importa com
							bancos de dados, rede ou sistema de ficheiros.
						</p>
					</Box>

					<div className='grid grid-cols-1 xl:grid-cols-2 gap-10'>
						<Box className='bg-zinc-900 text-white p-10 border-none shadow-[10px_10px_0px_#10b981]'>
							<h4 className='text-xl font-black uppercase mb-4 text-emerald-400'>
								🩺 A analogia do mecânico
							</h4>
							<p className='text-lg leading-relaxed mb-6'>
								Imagine um mecânico que quer verificar o motor de um carro. Ele
								não dirige 100km na estrada. Ele retira o motor, coloca-o numa
								bancada e testa cada peça: o alternador, o carburador, a
								correia.
							</p>
							<p className='italic text-zinc-400'>
								"Retirar a função do contexto para a bancada de testes."
							</p>
						</Box>
						<div className='space-y-4'>
							<h4 className='text-xl font-black uppercase border-b-4 border-emerald-500 pb-2 mb-6'>
								Características
							</h4>
							<ul className='space-y-3 font-bold text-lg'>
								<li className='flex items-center gap-3'>
									<span className='text-emerald-500'>✔</span> Rápidos:
									milissegundos
								</li>
								<li className='flex items-center gap-3'>
									<span className='text-emerald-500'>✔</span> Isolados: sem
									efeitos colaterais
								</li>
								<li className='flex items-center gap-3'>
									<span className='text-emerald-500'>✔</span> Determinísticos:
									sempre o mesmo resultado
								</li>
								<li className='flex items-center gap-3'>
									<span className='text-emerald-500'>✔</span> Focados: uma só
									responsabilidade
								</li>
							</ul>
						</div>
			...
			<section className='mb-24'>
				...
				<div className='space-y-12'>
					<Box className='bg-amber-50/50 dark:bg-amber-950/10 border-amber-500 p-8'>
						...
						<p className='text-lg leading-relaxed'>
							Um teste de integração verifica se{" "}
							<strong>duas ou mais unidades</strong> funcionam corretamente
							juntas. A pergunta é: "Estas peças que funcionam individualmente,
							também funcionam quando conectadas?"
						</p>
					</Box>

					<div className='grid grid-cols-1 xl:grid-cols-2 gap-10'>
						<Box className='bg-zinc-100 dark:bg-zinc-800 p-10 border-l-8 border-amber-500 brutalist-shadow'>
							<h4 className='text-xl font-black uppercase mb-4 text-amber-600 italic'>
								🩺 A analogia continuada
							</h4>
							<p className='text-lg leading-relaxed mb-6'>
								O mecânico já testou o motor e a caixa de câmbio
								individualmente. Agora ele verifica se, ao acoplar o motor à
								caixa, a rotação é transmitida corretamente.
							</p>
						</Box>
						<div className='space-y-4'>
							<h4 className='text-xl font-black uppercase border-b-4 border-amber-500 pb-2 mb-6'>
								Contratos de Interface
							</h4>
							<p className='text-lg font-medium'>
								Muitos bugs aparecem apenas nas interfaces entre as peças:
								quando o Módulo A envia dados num formato que o Módulo B não
								espera.
							</p>
						</div>
					</div>
					...
					<div>
						<h3 className='text-2xl font-black mb-6 uppercase text-amber-600'>
							Exemplo: Serviço e Repositório
						</h3>
						<CodeBlock
							language='typescript'
						...
						<Callout type='info' title='Repare na diferença' className='mt-8'>
							No teste de integração, verificamos não apenas o retorno da
							função, mas se houve a comunicação correta com o repositório/banco
							de dados.
						</Callout>
					</div>
				</div>
			...
			<section className='mb-24'>
				...
				<div className='space-y-12'>
					<Box className='bg-rose-50/50 dark:bg-rose-950/10 border-rose-500 p-8'>
						...
						<p className='text-lg leading-relaxed'>
							Um teste end-to-end verifica o sistema{" "}
							<strong>do início ao fim</strong> (ponta a ponta), simulando um
							utilizador real. Da interface até ao banco de dados, passando por
							todas as camadas.
						</p>
					</Box>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-12 flex items-center gap-4'>
					...
					<span className='border-b-8 border-primary'>Comparação direta</span>
				</h2>
				...
				<Box className='p-0 overflow-hidden border-8 border-black dark:border-white shadow-brutalist'>
					<table className='w-full text-left'>
						<thead className='bg-black text-white dark:bg-white dark:text-black uppercase'>
							<tr>
								<th className='p-4 border-r-2 border-white dark:border-black'>
									Cenário
								</th>
						...
						<tbody className='text-lg font-bold'>
							<tr className='border-b-4 border-black dark:border-white hover:bg-emerald-500/10'>
								<td className='p-4 border-r-2 border-black dark:border-white text-emerald-600'>
									Unitário
								</td>
								<td className='p-4 italic'>
									"A função calcularDesconto(100, 10) retorna 90?"
								</td>
							</tr>
							<tr className='border-b-4 border-black dark:border-white hover:bg-amber-500/10'>
								<td className='p-4 border-r-2 border-black dark:border-white text-amber-600'>
									Integração
								</td>
								<td className='p-4 italic'>
									"O carrinhoService.aplicarCupao("DES10") atualiza o total para
									90?"
								</td>
							</tr>
							<tr className='hover:bg-rose-500/10'>
								<td className='p-4 border-r-2 border-black dark:border-white text-rose-600'>
									E2E
								</td>
								<td className='p-4 italic'>
									"Ao clicar no botão "Aplicar Cupão", o utilizador vê o novo
									total no ecrã?"
								</td>
							</tr>
						</tbody>
			...
			<section className='mb-24'>
				<h2 className='text-4xl font-black uppercase mb-12 flex items-center gap-4'>
					...
					<span className='border-b-8 border-secondary'>A Proporção Ideal</span>
				</h2>
				...
				<Callout
					type='warning'
					title='Por que esta proporção?'
					className='mt-16'
				>
					A resposta é económica e prática. 500 testes E2E demorariam 40 minutos
					para executar. 500 testes unitários demoram menos de 1 segundo.{" "}
					<strong>Velocidade é vida para um programador.</strong>
				</Callout>
			</section>
			...
			<Box className='border-8 border-black dark:border-white p-16 bg-primary/5 mb-32 group hover:bg-primary/10 transition-colors'>
				...
				<div className='space-y-8 text-xl font-medium leading-relaxed text-zinc-800 dark:text-zinc-200'>
					<p>Crie um mini sistema de biblioteca com dois ficheiros:</p>
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
						<div className='p-6 bg-white dark:bg-zinc-900 border-4 border-black dark:border-white'>
							<h4 className='font-black uppercase mb-4 text-emerald-500'>
								Lógica (src/modulo-02/biblioteca.ts)
							</h4>
							<ul className='space-y-2 text-sm'>
								<li>
									• Função pura <code>calcularMulta(dias, preco)</code>
								</li>
								<li>
									• Serviço <code>servicoBiblioteca</code> com buscar, emprestar
									e devolver.
								</li>
							</ul>
						</div>
