...
import { Download, PieChart, Star, FileSpreadsheet } from "lucide-react";
			...
			<div className='flex flex-col md:flex-row md:items-end justify-between gap-8 mb-16 border-b-8 border-zinc-900 dark:border-zinc-100 pb-8'>
				<div>
					...
					<p className='text-zinc-700 dark:text-zinc-300 text-xl font-medium'>
						Duas provas parcelares (40%) e um Exame Final/Projeto Integrador
						(60%).
					</p>
				</div>
				<div className='flex flex-col gap-4'>
					<a
						...
						href='https://5gnshwxcnlopxrkn.public.blob.vercel-storage.com/Opcional%20II.pdf'
				...
				{EVALUACIONES.map((crit, idx) => (
					...
					>
						...
						<div className='flex items-end justify-between mb-8 relative z-10'>
							<div className='w-20 h-20 bg-zinc-900 dark:bg-white flex items-center justify-center border-2 border-transparent brutalist-shadow-secondary rotate-3 group-hover:-rotate-6 transition-transform'>
